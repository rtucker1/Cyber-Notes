...
To begin, ask students to define an operating system and provide any examples they know of. 
...
Introduce Linux as a contrast to these Unix systems. Explain that:

- Linux is a free, open-sourced operating system. 
- Linux provides more customization and flexibility for specificity of complex job functions compared to proprietary Unix operating systems.
- Since Linux is free and open sourced, there are various modified versions of Linux available, known as  distributions. 
    ...
    - For this sample lesson, we will work in Ubuntu. It is a very common and simple version of Linux that is suited well for beginners.  Explain that even though there are many different distributions, we will be covering the basics today. These basics are universal amongst all major Linux distributions. (So what you learn today in Ubunto will be applicable if you work with Kali down the line.)
...
- Explain that Linux is fundamental to the tech world and more specifically the cybersecurity field. Let student's know that they may be surprised by how many companies, applications, and gadgets are built on Linux. But we will let them see for themselves.
...
- Instructions: 
    ...
    - As you start finding jobs, answer the following questions: 
        1. Which job titles reoccur the most?
        2. Do these postings mention specific distributions? Provide your best reasoning for why or why not?
        3. Are any other skills mentioned or associated with Linux. 
        - For example: "Applicants must know Linux in order to complete _job functions x, y, z_. 

### 3. Direct Instruction: Review Ubiquity of Linux (0:10) = (0:35)
...
- If applicable, explain to what extent you have used Linux in previous jobs or in your everyday life. 

Now that students have a conceptual understanding of Linux, we will walk-thru how to use the operating system despite the existing operating system of the students' computers. 

[LinuxEverywhere](linuxeverywhere.png)

### 4. Guided Practice: Installing VM and Linux (0:15) = (0:50) [Monkey See Monkey Do]

Now that students have a grasp of what Linux is, we can start using it. But first, we have to download it. 

- Explain to students that instead of uninstalling Windows or Mac and then installing Linux, we can run Linux on a simulated computer within Mac or Windows, known as a virtual machine.
...
- Instructions: 
    ...
    - Your instructor will walk-thru the process with you. Follow these steps as your instructor progresses through the process: 
    ...
    4. Once you are finished, you are ready to begin working in Linux. 

### 5. Direct Instruction: Review Installation and Explore Linux (0:10) = (0:60)
...
Tell students that the first tasks we will do in Linux is work on the command line. 
...
### 7. Guided Practice: Command Line Refresher (0:15) (0:75)

- In this activity, students will refresh their knowledge of command line functions.

- They will use the basic functions: `mkdir`, `cd`, `ls`, `cp`, `touch [file]`.
...
- Instructions: 
    ...
    Okay, it's hypothetical situtation time!

    - _Your're packing up and moving out of your childhood home. "Congratulations, it's about time", say your parents.  Before you move out, you have to pack up all your stuff._ In this exercise, we are going to simulate the process of packing up and moving out via files and directories on the command line. 

        1. Create a directory titled: `The Old House`.
        2. In `the old house`, you have _all this stuff_. Document what you want to take to your new apartment. Creating the following files: 
            - `My clothes` 
            - `My books` 
            - `My video games` 
            - `My toothbrush` 
        ...
        4. You really want to pack up your photo album, but your parents also want to keep those photos and hang them all over the wall. Make a copy of `My photo album`. Move the copied file out of `My stuff` and into `The Old House`. 
        5. Time to pack up. Move '`My stuff` from `The old house` and into a new directory: `My suitcase`.
        6. Everything won't fit. On second thought, you haven't played your video games in over 2 years, so there's no need to back it up. Delete the file `my video games`. 
        7. Move `my suitcase`  into a new directory outside of `The old house`. Call it  `my new apartment`. 
        8. You made it to your apartment. Make sure all your stuff made it too. List the content of `my suitcase`. 
...
### 8. Direct Instruction: Review Command Line (0:10) 
...
### 9. Direct Instruction: Permission (0:15) = (0:95)

### 10. Guided Practice: Inspecting Permissions (0:15)

### 8. Direct Instruction: Review Inspecting Permission (0:10)

#### 9.  Direct Instruction: Symbolic vs. Octal Notation (0:10)

#### 10. Guided Practice: Converting Symbolic Notation to Octal Notation (0:15)

#### 11.  Direct Instruction: Reveiw Symbolic / Octal Convertion (0:10)

### 12. Direct Instruction: chmod, sudo, chown Walk-thru (0:15)

### 13. Guided Practice: Setting Permissions (0:20)

### 14. Direct Instruction: Review Setting Permissions (0:10)
